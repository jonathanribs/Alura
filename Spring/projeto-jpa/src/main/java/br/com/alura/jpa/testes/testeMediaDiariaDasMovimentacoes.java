...
public class testeMediaDiariaDasMovimentacoes {
	public static void main(String[] args) {
		...
		String jpql = "select new br.com.alura.jpa.modelo.MediaComData(avg(m.valor), day(m.data), month(m.data)) from Movimentacao m group by day(m.data), month(m.data), year (m.data)"; //media
